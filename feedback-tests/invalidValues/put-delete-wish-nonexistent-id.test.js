...
describe('Проверка эндпоинтов /wish с некорректным recipeId', () => {
  beforeAll(async () => {
    requests = new appReq(baseFeedbackUrl, null, path)
  })

  it('Проверка метода добавления в избранное c несуществующим recipeId', async () => {
  ...
  it('Проверка метода удаления из списка избранных c несуществующим recipeId', async () => {
